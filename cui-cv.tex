...
{\bf Software systems for large scale machine learning}
...
\item[] {\bf Stale Synchronous Parallel (SSP): trading data freshness for speed.}
    ...
    \emph{Work published in NIPS'13 and ATC'14. The ideas are implemented in LazyTable.}
\vspace{.1in}
...
\item[] {\bf Multi-class Bloom Filter (MBF).}
    ...
    \emph{Work published in ICNP'11}.
\end{innerlist}
...
\begin{innerlist}
    \item[] Caffe, GraphLab, HBase, OpenTSDB, Spark, Hadoop, git, LaTeX, svn
\end{innerlist}
\vspace{.1in}
