...
\item Designing and owning the production deep learning model for predicting the trajectories of the vehicle actors on the road. The model predicts multiple trajectories for each actor with probabilities, uncertainty estimation, and vehicle kinematics constraints.
