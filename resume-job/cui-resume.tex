...
\hspace{-1em} Big data Systems & TensorFlow, Spark, Caffe, MPI, GraphLab, HBase, OpenTSDB, Hadoop\\
\end{tabular}
\end{rSection}
\vspace{-.05in}
...
\hspace{-1em} \textbf{Program Committee}: CVPR ``Precognition: Seeing through the Future'' Workshop \hfill {2019}
