...
% \small{
\item Designed GeePS, a parameter server system for distributed deep learning on a cluster of GPU machines.
\item Extended Caffe, a popular deep learning system, to run on distributed machines, by using GeePS.
